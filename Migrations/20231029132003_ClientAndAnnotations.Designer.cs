...
namespace RazorPagesZenSpaCh7.Migrations
{
    ...
    [Migration("20231029132003_ClientAndAnnotations")]
            ...
            modelBuilder.Entity("RazorPagesZenSpaCh7.Models.ClientService", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            ClientID = 1,
                            Date = new DateTime(2023, 10, 29, 9, 20, 3, 400, DateTimeKind.Local).AddTicks(3475),
                            ServicesID = 1
                        },
                        new
                        {
                            ID = 2,
                            ClientID = 2,
                            Date = new DateTime(2023, 10, 29, 9, 20, 3, 400, DateTimeKind.Local).AddTicks(3595),
                            ServicesID = 7
                        },
                        new
                        {
                            ID = 3,
                            ClientID = 1,
                            Date = new DateTime(2023, 10, 29, 9, 20, 3, 400, DateTimeKind.Local).AddTicks(3597),
                            ServicesID = 5
                        });
                });
