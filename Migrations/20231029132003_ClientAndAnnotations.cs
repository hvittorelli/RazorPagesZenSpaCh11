    ...
    public partial class ClientAndAnnotations : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2023, 10, 29, 9, 20, 3, 400, DateTimeKind.Local).AddTicks(3475), 1 },
                    { 2, 2, new DateTime(2023, 10, 29, 9, 20, 3, 400, DateTimeKind.Local).AddTicks(3595), 7 },
                    { 3, 1, new DateTime(2023, 10, 29, 9, 20, 3, 400, DateTimeKind.Local).AddTicks(3597), 5 }
                });
